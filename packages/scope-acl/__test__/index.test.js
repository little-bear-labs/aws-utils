...
describe('ScopeACL', () => {
    ...
    describe('it should pass for valid scopes', () => {
      [
        ...
        },
        {
          ...
          matches: [
            'foo::QUX::quxr::!',
            'foo::thisisalongstringfullofthings999999::quxr::!',
          ],
      ...
      ].forEach(({ scope, expected, matches = [], nonMatches = [] }) => {
        describe(`for ${scope}`, () => {
  ...
  describe('scope workflows', () => {
    it('should add scope', async () => {
      const manager = new subject.Manager(
        awsConfig.tables.UserScopesTable,
        dynamodb,
      );
      const id = 'foo';
